...
export default function DashboardPage() {
  ...
  const { blogPosts, setBlogPosts, addBlogPost, updateBlogPost, deleteBlogPost } = useBlog();
  ...
  const handleUpdate = (id: number) => {
    if (editPost.title.trim() && editPost.authorName.trim()) {
      const updatedPost: BlogPost = {
        ...
        authorImage: editPost.authorImage || blogPosts.find(p => p.id === id)?.authorImage || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face&auto=format&q=80",
        blogImage: editPost.blogImage || blogPosts.find(p => p.id === id)?.blogImage || "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=400&h=250&fit=crop&auto=format&q=80",
        createdAt: blogPosts.find(p => p.id === id)?.createdAt || new Date(),
        published: blogPosts.find(p => p.id === id)?.published || true
      };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                onChange={(e) => setNewPost({ ...newPost, blogImage: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            type="url"
                            value={editPost.authorImage}
                            onChange={(e) => setEditPost({ ...editPost, authorImage: e.target.value })}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          />
                        </div>
                        <div className="md:col-span-2">
                          ...
                          <input
                            type="url"
                            value={editPost.blogImage}
                            onChange={(e) => setEditPost({ ...editPost, blogImage: e.target.value })}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          />
                        </div>
                        <div className="md:col-span-2">
