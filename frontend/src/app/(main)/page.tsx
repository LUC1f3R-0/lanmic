      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div
              className="group relative overflow-hidden rounded-2xl p-8 hover-tilt border border-blue-200 shadow-lg bg-cover bg-center min-h-[320px]"
              style={{
                backgroundImage:
                  "url(/calciam_carbonate_filler_masterbatch_image.png)",
              }}
              data-aos="zoom-in-rotate"
              data-aos-delay="100"
              data-aos-duration="1000"
            ...
            <div
              className="group relative overflow-hidden rounded-2xl p-8 hover-tilt border border-purple-200 shadow-lg bg-cover bg-center min-h-[320px]"
              style={{
                backgroundImage: "url(/white_masterbatch_image.png)",
              }}
              data-aos="zoom-in-rotate"
              data-aos-delay="200"
              data-aos-duration="1000"
